...
public class WebSecurityConfig {
    ...
    protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.cors(cors -> cors.configurationSource(corsConfigurationSource())) // CORS 설정
            ...
            .httpBasic(
                httpBasicCustomizer -> httpBasicCustomizer.disable()) // 기본 인증 방식 (Basic Auth) 비활성화 -> Bearer 인증 방식을 사용하기 위해
            .sessionManagement(sessionManagement -> sessionManagement.sessionCreationPolicy(
                SessionCreationPolicy.STATELESS)) // 세션 관리 정책을 무상태로 설정
            .authorizeHttpRequests(
                request -> request
                    .requestMatchers("/api/v1/auth/**", "/oauth2/**", "/swagger-ui/**", "/error")
...
//
            ...
            .exceptionHandling(exceptionHandling -> exceptionHandling.authenticationEntryPoint(
                ...
                UsernamePasswordAuthenticationFilter.class); // JWT 인증 필터를 UsernamePasswordAuthenticationFilter 앞에 추가
