...
const SwiperProfile = ({ userList, delay }: Props) => {
  return (
    <Swiper
      ...
      {userList.map((user) => (
        <SwiperSlide>
          <div className="w-full px-10 py-2 grid grid-cols-[1fr_6fr_2fr] hover:scale-110 duration-200 cursor-pointer" key={user.rank}>
            ...
            <div className="flex items-center">
              <img className="w-9 h-9 mr-3 border rounded-[50%]" src={user.profileImage === null ? "/assets/user/defaultProfile.png" : user.profileImage} alt="" />
