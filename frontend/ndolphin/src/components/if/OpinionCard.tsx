...
const OpinionCard = ({ opinion }: Props) => {
  return (
    <div className="h-80 p-5 border-solid border-[#565656] border-[1px] rounded-lg grid grid-rows-[15%_25%_60%]">
      ...
      <p className="my-3 text-justify line-clamp-2">{opinion.title}</p>
