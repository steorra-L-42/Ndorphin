...
const BalanceCard = ({ balance }: Props) => {
  ...
  return (
    <div className="h-64 p-5 border-solid border-[#565656] border-[1px] rounded-lg grid grid-rows-[15%_30%_15%_40%] cursor-pointer" onClick={() => goToDetail(balance.id, "vote")}>
