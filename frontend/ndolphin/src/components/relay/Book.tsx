  ...
  return (
    <div className="flex flex-col items-center">
      <div className="w-full mr-36 flex justify-end">
        {join ? <p className="mx-1 px-3 py-1 rounded-t-lg text-xs font-bold text-zinc-900 bg-amber-300">참여</p>
          : <p className="mx-1 px-3 py-1 rounded-t-lg text-xs font-bold text-zinc-900 bg-zinc-300">미참여</p>}
      </div>

      <div className="relative">
        <img src="/assets/heart.png" className="w-9 absolute top-4 right-3 z-10" alt="#" />
        <img src="/assets/cover.jpg" className="w-72 h-[24rem] rounded-md" alt="#" />
      </div>

      <div className="w-full flex flex-col ml-36">
        <span className="pt-2 font-bold text-lg">혼자서 본 영화</span>
