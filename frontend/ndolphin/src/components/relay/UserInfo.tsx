      ...
      <div className="px-14 py-2" key={user}>
        <div className="flex justify-between items-center">
          <div className="w-full flex items-center">
            <img onClick={handleUserClick} className="w-9 h-9 mx-3 rounded-[50%] cursor-pointer hover:brightness-90 transition duration-200 ease-in-out" src={`${userImage ? userImage : "/assets/user/defaultProfile.png"}`} alt="" />
